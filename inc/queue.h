...
#define ONEAHEAD	"%s (%ld:%02ld) There is 1 user queued ahead of you (%i users %i queued)\r\n"

#define MANYAHEAD	"%s (%ld:%02ld) There are %d users queued ahead of you (%i users %i queued)\r\n"
...
#define IFYOUHADCLIENT	"(If you had the BBS client you would have started with only %i users queued\r\nahead of you!  See the Client> forum for more information.)\r\n\n"
